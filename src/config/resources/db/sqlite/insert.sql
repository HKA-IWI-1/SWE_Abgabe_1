...
INSERT INTO produktionsstudio(id, name, film_id)
VALUES (2, 'Bavaria Film', 2);
INSERT INTO produktionsstudio(id, name, film_id)
VALUES (3, 'Pinewood Studios', 3);
INSERT INTO produktionsstudio(id, name, film_id)
VALUES (4, 'BW Film', 4);
INSERT INTO produktionsstudio(id, name, film_id)
VALUES (5, 'SF Studios', 5);

INSERT INTO produzent(id, vorname, nachname, film_id)
VALUES (1, 'Frank', 'Müller', 1);
INSERT INTO produzent(id, vorname, nachname, film_id)
VALUES (2, 'Gustav', 'Gans', 1);
INSERT INTO produzent(id, vorname, nachname, film_id)
VALUES (3, 'Robert', 'Rühl', 2);
INSERT INTO produzent(id, vorname, nachname, film_id)
VALUES (4, 'Sofia', 'Sahl', 2);
INSERT INTO produzent(id, vorname, nachname, film_id)
VALUES (5, 'Peter', 'Putz', 3);
INSERT INTO produzent(id, vorname, nachname, film_id)
VALUES (6, 'Anette', 'Ahne', 4);
INSERT INTO produzent(id, vorname, nachname, film_id)
VALUES (7, 'Susi', 'Schnell', 5);
INSERT INTO produzent(id, vorname, nachname, film_id)
VALUES (8, 'Bettina', 'Burg', 5);
